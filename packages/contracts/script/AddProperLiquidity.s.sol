...
contract AddProperLiquidity is Script {
    ...
    function run() external {
        ...
        console.log("Adding PROPER liquidity to pool");
        ...
        uint128 amount1Max = 1000000000000;

        console.log("Position Parameters:");
        console.log("  Liquidity:", liquidityAmount);
        console.log("  Full range position (max ticks)");
        console.log("");
